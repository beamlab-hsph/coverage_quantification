...
def main(): 
  parser = argparse.ArgumentParser("Find hyper-parameters for SVI and LL SVI networks")
  parser.add_argument("--method", type=int, help="Method to train", choices=['svi', 'll_svi'])
