...
base_dir <- '.' #wd should be parent dir of the repo
...
p_coverage
ggsave('./reports/figures/cifar_corruption_coverage.png', device = 'png', p_coverage, width=10, height=4, units='in')
...
p_width
ggsave('./reports/figures/cifar_corruption_width.png', device = 'png', p_width, width=10, height=4, units='in')
...
p_entropy
ggsave('./reports/figures/cifar_corruption_entropy.png', device = 'png', p_entropy, width=10, height=4, units='in')
